...
public class Menu extends javax.swing.JFrame {
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {                                             
     java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            List<Cita> citas = Cita.obtenerCitas(); // Obtener la lista de citas guardadas
            Consultar consultarFrame = new Consultar(citas); // Crear una instancia de la clase Consultar
            consultarFrame.setVisible(true); // Hacer visible la ventana Consultar
        }
    });
    this.setVisible(false); // Ocultar la ventana actual (Menú)
